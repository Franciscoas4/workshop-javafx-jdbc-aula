...
public class SellerFormController implements Initializable {
	...
	public void updateFormData() {
		if (entity == null) {
			throw new IllegalStateException("A entitdade está vazia");
		}
...
//		}
	...
	public void loadAssociatedObjects() {
		if (departmentService == null) {
			throw new IllegalStateException("DepatmentService está vazio");
		}
	...
	private void setErrorMesage(Map<String, String> errors) {
